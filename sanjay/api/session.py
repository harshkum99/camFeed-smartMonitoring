...
DEFAULT_TENANT = os.environ.get("SANJAY_TENANT", "11111111-1111-1111-1111-111111111111")
DEFAULT_SITE = os.environ.get("SANJAY_SITE", "aaaaaaaa-0000-0000-0000-000000000001")
...
async def current_session(
    x_sanjay_actor: str | None = Header(default=None),
    x_sanjay_tenant: str | None = Header(default=None),
    x_sanjay_site: str | None = Header(default=None),
    x_sanjay_roles: str | None = Header(default=None),
) -> Session:
    """Resolve the caller.
    ...
    """
    return Session(
        tenant_id=x_sanjay_tenant or DEFAULT_TENANT,
        site_id=x_sanjay_site or DEFAULT_SITE,
        actor=x_sanjay_actor or "console",
        roles=frozenset((x_sanjay_roles or "operator,admin").split(",")),
    )
